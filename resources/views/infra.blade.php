	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				...
				<div class="container-fluid">
				@if($flag==0)
	<form enctype="multipart/form-data" method="POST" action="/infrasurvey">
            {!! csrf_field() !!}	
<table border="">
...
<tr align="CENTER">
	<td class="index">1.</td>
<td align="LEFT">
 Is branch developed in line with approved layout plan</td>
...
<tr align="CENTER">
	<td class="index">4.</td>
<td align="LEFT">
Quality of Civil Work, if applicable (Toilets, Pantry, etc)</td>
...
<td class="index">5.</td>
		<td align="LEFT">
Did you receive information on project timelines, point of contact, etc.</td>
...
<td><input type="text" name="remark5" placeholder="Enter Remark" required></td>
	...
	<tr align="CENTER">
		<td class="index">6.</td>
<td align="LEFT">
Were Critical equipment’s like DG, UPS, AC, Server Rack, Fire Panel, Lease line installed before handover</td>
...
<td><input type="text" name="remark6" placeholder="Enter Remark" required></td>
	...
	<tr align="CENTER">
		<td class="index">7.</td>
<td align="LEFT">
Quality of signage provided</td>
...
<td><input type="text" name="remark8" placeholder="Enter Remark" required></td>
		...
		<tr align="CENTER">
			<td class="index">9.</td>
<td align="LEFT">
How would you rate your overall experience with this project?</td>
